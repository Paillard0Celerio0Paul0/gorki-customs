    ...
    const demoGames: Game[] = [
      ...
      },
      {
        ...
        blueTeam: {
          name: 'Team Alpha',
          players: [
            { pseudo: 'Alpha1', champion: 'Lucian', role: 'ADC' },
            { pseudo: 'Alpha2', champion: 'Braum', role: 'SUPPORT' },
            { pseudo: 'Alpha3', champion: 'Azir', role: 'MID' },
            { pseudo: 'Alpha4', champion: 'Rek\'Sai', role: 'JUNGLE' },
            { pseudo: 'Alpha5', champion: 'Maokai', role: 'TOP' },
          ]
        },
        redTeam: {
          name: 'Team Beta',
          players: [
            { pseudo: 'Beta1', champion: 'Kai\'Sa', role: 'ADC' },
            { pseudo: 'Beta2', champion: 'Alistar', role: 'SUPPORT' },
            { pseudo: 'Beta3', champion: 'LeBlanc', role: 'MID' },
            { pseudo: 'Beta4', champion: 'Jarvan IV', role: 'JUNGLE' },
            { pseudo: 'Beta5', champion: 'Camille', role: 'TOP' },
          ]
        },
        blueScore: 22,
        redScore: 15,
